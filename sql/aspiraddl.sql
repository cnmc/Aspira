...
CREATE TABLE "APP"."UIEVENT" ("DEVICEID" VARCHAR(16) NOT NULL, "PATIENTID" VARCHAR(16) NOT NULL, "VERSION" VARCHAR(16) NOT NULL, "EVENTTYPE" VARCHAR(64) NOT NULL, "EVENTTARGET" VARCHAR(64) NOT NULL, "EVENTVALUE" VARCHAR(1024) NOT NULL, "EVENTTIME" TIMESTAMP NOT NULL);
