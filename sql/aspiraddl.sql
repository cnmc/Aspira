...
CREATE TABLE "APP"."PATIENT" ("PATIENTID" VARCHAR(10) NOT NULL, "SEX" CHAR(1), "PATIENTNOTES" VARCHAR(4096), "BESTVALUETYPE" VARCHAR(16), "BESTVALUETARGET" INTEGER, "RATEHIGH" INTEGER, "RATELOW" INTEGER, "VALUEHIGH" INTEGER, "VALUELOW" INTEGER);

CREATE TABLE "APP"."AQMONITOR" ("SERIALID" VARCHAR(64) NOT NULL, "VENDOR" VARCHAR(64) NOT NULL, "MODEL" VARCHAR(64) NOT NULL, "DESCRIPTION" VARCHAR(1024), "PATIENTID" VARCHAR(10));

CREATE TABLE "APP"."SPIROMETER" ("SERIALID" VARCHAR(64) NOT NULL, "VENDOR" VARCHAR(64) NOT NULL, "MODEL" VARCHAR(64) NOT NULL, "DESCRIPTION" VARCHAR(1024), "PATIENTID" VARCHAR(10));

CREATE TABLE "APP"."CLINICIAN" ("CLINICIANID" VARCHAR(10) NOT NULL);
...
CREATE TABLE "APP"."PATIENT_CLINICIAN" ("PATIENTID" VARCHAR(10) NOT NULL, "CLINICIANID" VARCHAR(10) NOT NULL);
