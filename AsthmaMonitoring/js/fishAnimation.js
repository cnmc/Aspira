...
function createAnimationDiv() {
    ...
    debugLog("debug", "entering function", "createAnimationDiv");
    ...
    debugLog("debug", "leaving function", "createAnimationDiv");
}
function initializeAnimation() {
    debugLog("debug", "entering function", "initializeAnimation");
    if (document.getElementById("animationMainContainer")) {
        document.getElementById("animationMainContainer").removeNode(true);
    }
    createAnimationDiv();
    fishFloat();
    debugLog("debug", "leaving function", "initializeAnimation");
}
...
function calculateImageToShow() {
    debugLog("debug", "entering function", "calculateImageToShow");
    ...
    debugLog("debug", "leaving function", "calculateImageToShow");
}
